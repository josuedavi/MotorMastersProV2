...
import { Bell, ListFilter, ExternalLink } from "lucide-react";
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <Select value={statusFilter} onValueChange={setStatusFilter}>
                                ...
                                <SelectContent className="bg-gray-800 border-gray-600">
                                    {statuses.map(s => (
                                        <SelectItem key={s} value={s} className="text-white capitalize">{s.replace(/_/g, " ")}</SelectItem>
                                    ))}
                                </SelectContent>
                            </Select>
                        </div>
                                    ...
                                    >
                                        <TableCell className="font-medium text-white">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                {order.has_customer_update && <Bell className="w-4 h-4 text-orange-400 animate-pulse" />}
                                            </div>
                                        </TableCell>
                                        ...
                                        <TableCell className="text-gray-300">{order.package_name}</TableCell>
                                        <TableCell>
